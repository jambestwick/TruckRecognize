    ...
    public OkHttpUtils<T> addParam(String key, String value) {
        try {
            ...
            if (mFormBodyBuilder != null) {//post请求的参数添加方式
                ...
                Log.e("OkHttpUtils", "value=" + value);
                mUrl.append(key).append("=").append(URLEncoder.encode(URLEncoder.encode(value, UTF_8)));
            }
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        Log.e("OkHttpUtils", "网络请求Url=" + mUrl);
        return this;
    }
